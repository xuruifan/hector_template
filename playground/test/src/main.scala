...
class TopModule extends MultiIOModule {
  ...
  mem_global_0.initMem("mem_0.txt")
  mem_global_1.initMem("mem_1.txt")
  mem_global_2.initMem("mem_2.txt")
  mem_global_3.initMem("mem_3.txt")
  ...
  class outline_0 extends MultiIOModule {
    ...
    val var66 = mulf_outline_0_0.lhs
    var66 := DontCare
    val var67 = mulf_outline_0_0.rhs
    var67 := DontCare
    val var68 = mulf_outline_0_0.result
    val addf_outline_0_0 = Module(new AddSubFBase(10, 11, 53, true))
    addf_outline_0_0.enable := true.B
    val var69 = addf_outline_0_0.lhs
    var69 := DontCare
    val var70 = addf_outline_0_0.rhs
    var70 := DontCare
