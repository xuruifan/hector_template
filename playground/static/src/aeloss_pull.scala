...
class aeloss_pull extends MultiIOModule {
  ...
  class outline_0 extends MultiIOModule {
    ...
    val var311 = addf_outline_0_0.operand0
    var311 := DontCare
    val var312 = addf_outline_0_0.operand1
    var312 := DontCare
    val var313 = addf_outline_0_0.result
    val mulf_outline_0_0 = Module(new MulFBase(9, 11, 53))
    mulf_outline_0_0.ce := true.B
    val var314 = mulf_outline_0_0.operand0
    var314 := DontCare
    val var315 = mulf_outline_0_0.operand1
    var315 := DontCare
    val var316 = mulf_outline_0_0.result
    val subf_outline_0_0 = Module(new AddSubFBase(13, 11, 53, false))
    subf_outline_0_0.ce := true.B
    val var317 = subf_outline_0_0.operand0
    var317 := DontCare
    val var318 = subf_outline_0_0.operand1
    var318 := DontCare
    val var319 = subf_outline_0_0.result
    val addf_outline_0_1 = Module(new AddSubFBase(13, 11, 53, true))
    addf_outline_0_1.ce := true.B
    val var320 = addf_outline_0_1.operand0
    var320 := DontCare
    val var321 = addf_outline_0_1.operand1
    var321 := DontCare
    val var322 = addf_outline_0_1.result
  ...
  class main extends MultiIOModule {
    ...
    val var326 = IO(Output(UInt(64.W)))
    var326 := DontCare
    val var327 = Reg(UInt(64.W))
    val outline_0_0 = Module(new outline_0)
    outline_0_0.go := 0.U
    val var328 = outline_0_0.var12
    var328 := DontCare
    val var329 = outline_0_0.var13
    var329 := DontCare
    val var330 = outline_0_0.var14
    var330 := DontCare
    val var331 = outline_0_0.var15
    val var332 = outline_0_0.done
